...
module "authentication_console" {
  ...
  source     = "app.terraform.io/Cisco-IST-TigerTeam/admin/aci//modules/authentication_console_v5"
  #
...
module "authentication_default" {
  source = "app.terraform.io/Cisco-IST-TigerTeam/admin/aci//modules/authentication_default_v5"
  #
