...
| remote\_host\_dn | The Distinguished Name of the remote host for the configuration export policy. | `string` | `""` | no |
| scheduler\_dn | The Distinguished Name of the scheduler policy used for running scheduled export jobs for the configuration export policy. | `string` | `""` | no |
